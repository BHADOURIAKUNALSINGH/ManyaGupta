          ...
          return (
            ...
            >
              <motion.div
                ...
                className="w-full h-full bg-[#361B19] text-[#F5EFE6] rounded-[2rem] shadow-2xl p-8 sm:p-10 flex flex-col justify-between border border-[#F5EFE6]/10 relative overflow-hidden group"
              >
                ...
                <div className="max-w-2xl">
                  <p className="text-base sm:text-lg text-[#F5EFE6]/80 leading-relaxed font-light font-body">
                    {card.description}
                  </p>
                </div>
              </motion.div>
